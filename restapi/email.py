...
def sendMail(body,toaddr):
    msg=MIMEText(body)
    fromaddr= "res@gmail.com" #the adress from which mail is sent # give acess to less secure apps
    # toaddr=""  # mail sent to
    ...
    server.login(fromaddr,"Shivral31")  #login to your the server with the correct password
